...
public class BestPayConfig {
    ...
    public BestPayService bestPayService(){
        ...
        wxPayConfig.setNotifyUrl("http://main.wast.club/pay/notify");
        ...
        aliPayConfig.setNotifyUrl("http://main.wast.club/pay/notify");
        aliPayConfig.setReturnUrl("http://main.wast.club");
